...
public class ExtentReportManager implements ITestListener {
	...
	//updating the reports after every execution
	...
	public void onFinish(ITestContext testContext) {
		...
		//code to send details to the external source directly on generation
		/*
		 * try { URL url = new
		 ...
		 * email.setAuthenticator(new DefaultAuthenticator("tes@gmail.com","password")); 
